...
public class Storage extends GameObject {
    ...
    // FULL CONSTRUCTOR
    public Storage(String type, String id, int lvl, int maxLVL,
    ...
    public Storage(StorageData storageData, String type, String id, int lvl, int xPos, int yPos) {
        super(type, id, lvl, storageData.getMaxLVL(), xPos, yPos,
                storageData.getSprite_path(), storageData.getDescription());
    ...
    public String toString() {
        return "Storage{id='" + id + "', type='" + type
                + "', lvl=" + lvl
                + ", pos=[" + xPos + "," + yPos + "]"
