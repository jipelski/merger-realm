...
public class Prince extends GameObject {
    ...
    // FULL CONSTRUCTOR
    public Prince(String type, String id, int lvl, int maxLVL,
    ...
    public Prince(PrinceData princeData, String type, String id, int lvl, int xPos, int yPos) {
        super(type, id, lvl, princeData.getMaxLVL(), xPos, yPos,
                princeData.getSprite_path(), princeData.getDescription());
